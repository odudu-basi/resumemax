-- =====================================================
-- Auto-Apply Sessions Schema - STANDALONE VERSION
-- =====================================================
-- This version works WITHOUT the saved_jobs table
-- Safe to apply to any Supabase database
-- =====================================================
...
-- =====================================================
-- You can now use the auto_apply_sessions table
--
-- Test it:
-- SELECT * FROM auto_apply_sessions;
-- SELECT * FROM active_auto_apply_sessions;
