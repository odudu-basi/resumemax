    ...
    Tables: {
      ...
      auto_apply_sessions: {
        Row: {
          ...
          filled_form_data: any | null; // Stores the actual filled values for re-filling
          user_profile_data: any | null; // Stores user profile used for filling
          started_at: string;
        ...
        Insert: {
          ...
          screenshot_path?: string | null;
          video_path?: string | null;
          filled_form_data?: any | null;
          user_profile_data?: any | null;
          started_at?: string;
          filled_at?: string | null;
          expires_at?: string | null;
          submitted_at?: string | null;
